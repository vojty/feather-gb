// Fixed https://github.com/sn-satyendra/webpack-font-preload-plugin
// - handles publicPath: 'auto' correctly
const RawSource = require('webpack-sources/lib/RawSource')
const JsDom = require('jsdom')

function getPublicPath(outputOptions) {
  if (!outputOptions) {
    return ''
  }
...
class WebpackFontPreloadPlugin {
  ...
  addFonts(compilation, callback) {
    try {
      ...
      const publicPath = getPublicPath(outputOptions)
      if (indexSource) {
        let strLink = ''
